        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">Form Pencarian</h3>
                    </div>
                </div>
            </div>
            <!-- END: Subheader -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-body" >
                                        ...
                                        <br>
                                        <table id="table_cari" class="table table-striped" cellspacing="0" width="100%">
                                            <thead style="font-size: 12px; color: black;">
                                            <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#table_cari').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('operator/Cari/ajax_list') ?>",
                "type": "POST"
            },
