        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">Master Kolektor</h3>
                    </div>
                </div>
            </div>
            <!-- END: Subheader -->
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="m-portlet" id="m_portlet">
                            ...
                            <div class="m-portlet__body">
                                ...
                                echo form_open('operator/Kolektor/kolektor_tambah', $attributes);
                                ?>

                                <div class="form-group m-form__group row">
                                    <label class="col-md-2 col-form-label">Nama Kolektor</label>
                                    <div class="col-md-4">
