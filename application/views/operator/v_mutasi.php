        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">Registrasi Mutasi</h3>
                    </div>
                    <a href="<?php echo site_url('operator/LihatMutasi')?>" class="btn btn-primary m-btn m-btn--icon m-btn--wide m-btn--air m-btn--custom"><i class="la la-list-ol"> Lihat Data</i></a>
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="m-portlet" id="m_portlet">
                            ...
                            <div class="m-portlet__body">
                                ...
                                echo form_open('operator/Mutasi/mutasi_pelanggan', $attributes);
                                ?>
                                ...
                                <div class="form-group m-form__group row">
                                    <label class="col-md-2 col-form-label">Tanggal Mutasi</label>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group m-form__group row">
                                    <label class="col-md-2 col-form-label">Alamat Lama</label>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group m-form__group row">
                                    <label class="col-md-2 col-form-label">Alamat Baru</label>
                                    <div class="col-md-5">
                                        <textarea class="form-control" name="alamat2" id="alamat2" required></textarea>
                                    </div>
                                </div>
